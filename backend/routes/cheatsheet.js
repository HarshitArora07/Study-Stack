...
function formatCheatSheet(text) {
  ...
  // Split into sections (every ~10 lines -> 1 section)
  ...
  // Build numbered sections with sub-bullets
  let formatted = "";
...
router.post("/generate", upload.single("file"), async (req, res) => {
  ...
  try {
    ...
    // 1️⃣ Read file content if uploaded
    if (req.file) {
...
`;
    ...
    // 4️⃣ Call Hugging Face Router API
    ...
    try {
      ...
      // 6️⃣ Format cheat sheet with numbered sections
